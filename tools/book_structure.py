...
CHAPTERS = [
    ...
    Chapter("01_第一部_看见依赖/02_模型走出工厂.md", "01_第一部_看见依赖/02_第二章_模型走出工厂_能力怎样扩散与组合", "第一部　看见依赖", "第二章"),
    Chapter("01_第一部_看见依赖/03_什么是AI主权.md", "01_第一部_看见依赖/03_第三章_为什么AI需要主权", "第一部　看见依赖", "第三章"),
    Chapter("01_第一部_看见依赖/04_AgenticOps.md", "01_第一部_看见依赖/04_第四章_AgenticOps_管理会行动的AI", "第一部　看见依赖", "第四章"),
    Chapter("02_第二部_四级AI主权/05_个人_AI主权从自己开始.md", "02_第二部_四级AI主权/05_第五章_个人_AI主权从自己开始", "第二部　建设四级AI主权", "第五章"),
    Chapter("02_第二部_四级AI主权/06_组织_让部门自治而能力协同.md", "02_第二部_四级AI主权/06_第六章_组织_让部门自治而能力协同", "第二部　建设四级AI主权", "第六章"),
    Chapter("02_第二部_四级AI主权/07_企业_把智能变成可治理的能力.md", "02_第二部_四级AI主权/07_第七章_企业_把智能变成可治理的能力", "第二部　建设四级AI主权", "第七章"),
    Chapter("02_第二部_四级AI主权/08_国家与城市_让智能沉淀为本地生态.md", "02_第二部_四级AI主权/08_第八章_国家与城市_让智能沉淀为本地生态", "第二部　建设四级AI主权", "第八章"),
    Chapter("03_第三部_在依赖中保持自由/09_在依赖中保持自由.md", "03_第三部_在依赖中保持自由/09_第九章_在依赖中保持自由", "第三部　在依赖中保持自由", "第九章"),
    Chapter("03_第三部_在依赖中保持自由/10_AI_Native原生组织.md", "03_第三部_在依赖中保持自由/10_第十章_AI_Native原生组织_让组织围绕智能重新生长", "第三部　在依赖中保持自由", "第十章"),
    Chapter("04_结语/00_把选择留在自己手里.md", "04_结语/00_结语_把选择留在自己手里", "结语", "结语", "epilogue"),
]


PART_GUIDES_AFTER = {
    "序章": "01_第一部_看见依赖/00_第一部导读.md",
    "第四章": "02_第二部_四级AI主权/00_第二部导读.md",
    "第八章": "03_第三部_在依赖中保持自由/00_第三部导读.md",
}
...
ARTWORK = {
    ...
    ("第八章", "三条国家路径，最后都要回答能力留在哪里"): "图8-3",
    ("第八章", "城市是AI生态的落地接口"): "图8-4",
    ("第八章", "算力必须走进任务，才会留下能力"): "图8-5",
    ("第八章", "模型社区是城市的第二种基础设施"): "图8-6",
    ("第八章", "公共AI必须允许人申诉，也必须记得自己做过什么"): "图8-7",
    ("第八章", "数据、底座与替换构成公共边界"): "图8-8",
    ("第八章", "智能体进入城市以后，谁有资格定义问题"): "图8-9",
    ("第八章", "生产主体决定生态会不会生长"): "图8-10",
    ("第八章", "合作不能取消重新选择"): "图8-11",
    ("第八章", "宜昌：一座城市怎样把绿色算力接上生态"): "图8-2",
    ("第九章", "开放控制面：让驾驶舱不被发动机锁住"): "图9-1",
    ("第九章", "到二〇三五年：六项可验证预测"): "图9-2",
}
...
def merge_public_sovereignty() -> None:
    ...
    sources = {
        "government": ROOT / "02_第二部_四级AI主权/08_第八章_政府_让公共权力接受约束",
        "country": ROOT / "02_第二部_四级AI主权/09_第九章_国家_让智能沉淀为共同能力",
    }
    target = ROOT / "02_第二部_四级AI主权/08_第八章_国家与城市_让智能沉淀为本地生态"
    if target.exists():
    ...
    chapter = Chapter(
        "02_第二部_四级AI主权/08_国家与城市_让智能沉淀为本地生态.md",
