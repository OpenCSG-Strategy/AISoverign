...
Frank Chen 主理的中文书籍《AI 主权》正式稿，采用序章＋三部十一章＋结语＋附录。书稿结构见 `00_书稿导航.md`，章级与小节级物理路径见各章目录及 `90_出版工作台/01_结构与组装清单.md`。
...
3. **最后**才读 `05_附录/附录B_精选尾注.md` 核对脚注和数据来源
...
- **全书提质改写**(判断显性化/问题链/战略坐标/失败模式): 先读 `90_出版工作台/03_全书提质改写手册.md`, 第八章是唯一验收过的样板章
- 章内文件：`00_章节导读.md` → `01_*.md` 起；每个二级小节独立成文件，三级标题保留在所属小节内
- 脚注引用：正文里使用既有 `[^pX-*]` 等编号，统一定义在 `05_附录/附录B_精选尾注.md`
- 出版标注与图稿：遵守 `90_出版工作台/00_出版标注规范.md` 与 `90_出版工作台/02_图稿清单.md`
...
3. 脚注引用 —— 正文引用都在 `05_附录/附录B_精选尾注.md` 有唯一定义
