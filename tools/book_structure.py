...
CHAPTERS = [
    ...
    Chapter("02_第二部_四级AI主权/04_组织_让部门自治而能力协同.md", "02_第二部_四级AI主权/04_第四章_组织_让部门自治而能力协同", "第二部　建设四级AI主权", "第四章"),
    Chapter("02_第二部_四级AI主权/05_企业_把智能变成可治理的能力.md", "02_第二部_四级AI主权/05_第五章_企业_把智能变成可治理的能力", "第二部　建设四级AI主权", "第五章"),
    Chapter("02_第二部_四级AI主权/06_政府_让公共权力接受约束.md", "02_第二部_四级AI主权/06_第六章_政府_让公共权力接受约束", "第二部　建设四级AI主权", "第六章"),
    Chapter("02_第二部_四级AI主权/07_国家_让智能沉淀为共同能力.md", "02_第二部_四级AI主权/07_第七章_国家_让智能沉淀为共同能力", "第二部　建设四级AI主权", "第七章"),
    Chapter("03_第三部_在依赖中保持自由/08_在依赖中保持自由.md", "03_第三部_在依赖中保持自由/08_第八章_在依赖中保持自由", "第三部　在依赖中保持自由", "第八章"),
...
ARTWORK = {
    ...
    ("第四章", "每个部门都应有自己的AI域"): "图4-1",
    ("第四章", "一次产品发布怎样穿过五个部门"): "图4-2",
    ("第五章", "企业的AI能力网络"): "图5-1",
    ("第五章", "执行凭证：让一次任务可以被复盘"): "图5-2",
    ("第五章", "企业版AgenticOps：管理智能体生命周期"): "图5-3",
    ("第七章", "国家能力藏在危机到来以后"): "图7-1",
    ("第七章", "宜昌：一座城市怎样从资源投入走向能力反哺"): "图7-2",
    ("第八章", "开放控制面：让驾驶舱不被发动机锁住"): "图8-1",
    ("第八章", "到二〇三五年：六项可验证预测"): "图8-2",
}
