...
CHAPTERS = [
    ...
    Chapter("02_第二部_四级AI主权/04_个人_AI主权从自己开始.md", "02_第二部_四级AI主权/04_第四章_个人_AI主权从自己开始", "第二部　建设四级AI主权", "第四章"),
    Chapter("02_第二部_四级AI主权/05_组织_让部门自治而能力协同.md", "02_第二部_四级AI主权/05_第五章_组织_让部门自治而能力协同", "第二部　建设四级AI主权", "第五章"),
    Chapter("02_第二部_四级AI主权/06_企业_把智能变成可治理的能力.md", "02_第二部_四级AI主权/06_第六章_企业_把智能变成可治理的能力", "第二部　建设四级AI主权", "第六章"),
    Chapter("02_第二部_四级AI主权/07_政府_让公共权力接受约束.md", "02_第二部_四级AI主权/07_第七章_政府_让公共权力接受约束", "第二部　建设四级AI主权", "第七章"),
    Chapter("02_第二部_四级AI主权/08_国家_让智能沉淀为共同能力.md", "02_第二部_四级AI主权/08_第八章_国家_让智能沉淀为共同能力", "第二部　建设四级AI主权", "第八章"),
...
ARTWORK = {
    ...
    ("第二章", "开源打开的是哪一道门"): "图2-1",
    ("第二章", "模型之外的能力网络"): "图2-2",
    ("第三章", "一次请求，不等于一项任务"): "图3-1",
    ("第三章", "六种可以检验的能力"): "图3-2",
    ("第三章", "四个层级，一条责任链"): "图3-3",
    ("第四章", "本地、受控云与公共云"): "图4-1",
    ("第四章", "一套可搬走的个人智能栈"): "图4-2",
    ("第五章", "每个部门都应有自己的AI域"): "图5-1",
    ("第五章", "一次产品发布怎样穿过五个部门"): "图5-2",
    ("第六章", "企业的AI能力网络"): "图6-1",
    ("第六章", "执行凭证：让一次任务可以被复盘"): "图6-2",
    ("第六章", "企业版AgenticOps：管理智能体生命周期"): "图6-3",
    ("第八章", "国家能力藏在危机到来以后"): "图8-1",
    ("第八章", "宜昌：一座城市怎样从资源投入走向能力反哺"): "图8-2",
