...
企业的边界从来不是法律条文画出来的，而是交易成本算出来的；AI没有消灭企业，它正在改写这张成本表。
...
这场两极化同时是个人议价位置的重新排列。基础设施那一层，个人不可能也不必要参与竞争；市场入口那一层，一个人加几个数字角色已经进得去。夹在中间的个人，手里真正的筹码只有一种：可迁移性。模型可以换，平台可以换，前提是记忆、方法、客户关系和交付能力跟着人走，而不是留在某个账户里。四层资产在谁手里，谈判的位置就在谁手里；资产如果只存在于平台的内部结构中，个人就是在用别人的地基给自己的劳动定价。这也解释了为什么前面几节把那么多篇幅花在导出、边界和压力测试上——它们不是洁癖，是议价能力本身。[^p4-opc-mechanism]
